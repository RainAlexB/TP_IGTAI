...
Object *initPyramid(float height, float length, point3 center, Material mat){
    ...
    // les 4 faces
    ret->geom.pyramid.tri[0] = initTriangle(tip, point1, point2, mat);
    ret->geom.pyramid.tri[1] = initTriangle(tip, point2, point3_, mat);
    ret->geom.pyramid.tri[2] = initTriangle(tip, point3_, point4, mat);
    ret->geom.pyramid.tri[3] = initTriangle(tip, point4, point1, mat);
    //la base
    ret->geom.pyramid.tri[4] = initTriangle(point1, point3_, point4, mat);
    ret->geom.pyramid.tri[5] = initTriangle(point1, point2, point3_, mat);
    return ret;
}
